...
async function getUserVerification(roll_no) {
  ...
  if (
    res.user[0].registration === "YES" &&
    res.user[0].fee_payment === "FULL PAY" &&
    res.user[0].verification === "YES"
  ) {
    document.getElementById("registration-msg").innerHTML =
      "The Student has been Verified Successfully."
    ...
    document.getElementById("registration-msg").innerHTML =
      "Please verify the Student's Registration and Payment!";
    var btn = document.getElementById("verify-button");
    ...
    document.getElementById("registration-msg").innerHTML =
      "The Student has not completed the Registration and Fee Payment yet!";
    var btn = document.getElementById("verify-button");
